...
```
â”œâ”€â”€ assets          #Folder with files after compiling
â”œâ”€â”€ src             #Folder with sources
â”œâ”€â”€ tasks           #Folder with tasks for gulpfile
â”œâ”€â”€ LICENSE
â”œâ”€â”€ README.md
â”œâ”€â”€ gulp-config.js  #Config for gulp
â”œâ”€â”€ gulpfile.js     #File with gulp tasks
â”œâ”€â”€ index.html      #Main application
â””â”€â”€ package.json    #File with dependencies
...
â”œâ”€â”€ js                          #Folder for storing js files
   â”œâ”€â”€ modules                  #Folder for storing js modules
   â”œâ”€â”€ app.js                   #Main js file
â”œâ”€â”€ scss
   â”œâ”€â”€ abstracts                #Folder for storing scss files
      â”œâ”€â”€ _functions.scss       #Sass functions
      â”œâ”€â”€ _helpers.scss         #Sass helpers
      â”œâ”€â”€ _mixins.scss          #Sass mixins
      â”œâ”€â”€ _variables.scss       #Sass variables that we can use in our scss files
   â”œâ”€â”€ base                     #Folder for storing base styles
      â”œâ”€â”€ _forms.scss           #Sass styles for forms      
      â”œâ”€â”€ _main.scss            #Main scss file for base styles      
      â”œâ”€â”€ _reset.scss           #Sass reset
      â”œâ”€â”€ _typography.scss      #Sass styles for text      
   â”œâ”€â”€ components               #Global Reusable Presentational Components
   â”œâ”€â”€ layout                   #Global layout
   â”œâ”€â”€ pages                    #Global styles for pages
   â”œâ”€â”€ style.scss               #Main scss file (can be used for importing another files)
#This `templates` folder will be created if you choose a Pug option using jcn
â”œâ”€â”€ templates                   #Folder with pug templates
   â”œâ”€â”€ layouts                  #Folder with pug layouts
      â”œâ”€â”€ default.pug           #Example of the pug layout
   â”œâ”€â”€ mixins                   #Folder with pug mixins
      â”œâ”€â”€ article.pug           #Example of the pug mixin
   â”œâ”€â”€ views                    #Folder with pug pages
      â”œâ”€â”€ blog.pug              #Example of a blog page
      â”œâ”€â”€ index.pug             #Example of a index page
â”œâ”€â”€ vendor_entries              #Folder for vendor entries(plugins)
  â”œâ”€â”€ vendor.js                 #File for plugins js 
  â”œâ”€â”€ vendor.scss               #File for plugins styles
...
Sass is a CSS preprocessor â€” a layer between the stylesheets you author and the .css files you serve to the browser. Sass (short for Syntactically Awesome Stylesheets) plugs the holes in CSS as a language, allowing you to write DRY code thatâ€™ll be faster, more efficient, and easier to maintain. In our WSK we follow Sass [guidelines](https://sass-guidelin.es/#architecture).

So while normal CSS doesnâ€™t yet allow things like variables, mixins (reusable blocks of styles), and other goodies, Sass provides a syntax that does all of that and moreâ€”enabling â€œsuper functionalityâ€ in addition to your normal CSS.  
...
| build-js-vendors               | minifies and Ñompiles all vendor js from `src/vendor_entries`.                                                                                                |
